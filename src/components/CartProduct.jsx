...
import { deleteCartItem,increaseQty,decreaseQty } from "../redux/product";
    ...
    <div className="bg-slate-200 p-2 flex gap-4 rounded border border-slate-300">
      ...
      <div className="flex flex-col gap-1 w-full">
        <div className="flex justify-between">
          ...
          <div className="cursor-pointer text-richblack-800 hover:text-blue-800" onClick={()=>dispatch(deleteCartItem(id))}>
            <AiFillDelete />
          </div>
        </div>
